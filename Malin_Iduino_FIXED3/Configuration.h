...
#define CUSTOM_MENDEL_NAME "KEYES 3DPrt"
...
//杆两头中心点距离
//#define DELTA_DIAGONAL_ROD 186  //289    // mm  KEYES 20140927
#define DELTA_DIAGONAL_ROD 186  //289    // mm  KEYES 20150613


// Horizontal offset from middle of printer to smooth rod center.
//归位后，喷嘴中心点到球头的中心点
//#define DELTA_SMOOTH_ROD_OFFSET 139.58   //196.4 // mm  KEYES 20140927
#define DELTA_SMOOTH_ROD_OFFSET 148.5   //196.4 // mm  KEYES 20150613  153//2015/6/15

// Horizontal offset of the universal joints on the end effector.
//喷嘴中心点到球头的中心点
//#define DELTA_EFFECTOR_OFFSET 25   //25.5 // mm  KEYES 20140927
#define DELTA_EFFECTOR_OFFSET 39.43  //25.5 // mm  KEYES 20150613  32

// Horizontal offset of the universal joints on the carriages.
//球头的中心点到杆内侧距离
//#define DELTA_CARRIAGE_OFFSET 22.2      //  16.5 // mm  KEYES 20140927
#define DELTA_CARRIAGE_OFFSET 17.25     //  16.5 // mm  KEYES 20150613

// Horizontal distance bridged by diagonal push rods when effector is centered.
#define DELTA_RADIUS (DELTA_SMOOTH_ROD_OFFSET-DELTA_EFFECTOR_OFFSET-DELTA_CARRIAGE_OFFSET)

// Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
#define DELTA_PRINTABLE_RADIUS 90  // 100 KEYES 20140927
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current KEYES        BED 0 255
...
#define min_software_endstops true // If true, axis won't move to coordinates less than _POS.
...
#define MANUAL_HOME_POSITIONS  // If defined, MANUAL_*__POS below will be used
...
#define MANUAL_Z_HOME_POS 270 //300 // Distance between nozzle and print surface after homing. KEYES 20150615

//#define MANUAL_Z__POS 175  //300 // Distance between nozzle and print surface after homing. KEYES 20140927

//// MOVEMENT SETTINGS
#define NUM_AXIS 4 // The axis order in all axis related arrays is X, Y, Z, E
// #define HOMING_FEEDRATE {200*60, 200*60, 200*60, 0}  // set the homing speeds (mm/min)
//#define HOMING_FEEDRATE {200*30, 200*30, 200*30, 0}  // set the homing speeds (mm/min) 2014/12/18 TZB
#define HOMING_FEEDRATE {80*30, 80*30, 80*30, 0}  // set the homing speeds (mm/min) 20150131
// default settings
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 120}
